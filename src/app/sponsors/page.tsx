      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {logos.map((sponsor) => (
          <Link key={sponsor.name} href={sponsor.site} target="_blank" rel="noopener noreferrer">
            <Card className="p-6 bg-card/50 border-border/50 transition-all hover:shadow-lg hover:border-primary/50 hover:scale-105 grayscale hover:grayscale-0 opacity-75 hover:opacity-100 flex items-center justify-center h-full">
         ...
         <Link href="/onboarding/apply-sponsor" className="h-full">
            <Card className={cn("p-6 bg-card/50 border-dashed border-border/50 transition-all hover:shadow-lg hover:border-primary/50 hover:scale-105 flex items-center justify-center group", sizeClass, "h-full")}>
