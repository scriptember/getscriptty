import { getGithubIssues, GithubIssue } from "./actions";
...
async function IssuesList() {
    ...
    if (!result.success || !result.issues) {
        return <p className="text-destructive text-center">{result.error || "Could not load issues."}</p>;
    }

    const openIssues = result.issues.filter(issue => !issue.pull_request);
